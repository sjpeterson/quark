...
translateKey k = case k of
    ...
    Curses.KeyUnknown 573 -> SpecialKey "Ctrl-Up"
    Curses.KeyUnknown 574 -> SpecialKey "Ctrl-Shift-Up"
    Curses.KeyDown        -> SpecialKey "Down"
    Curses.KeyUnknown 530 -> SpecialKey "Ctrl-Down"
    Curses.KeyUnknown 531 -> SpecialKey "Ctrl-Shift-Down"
    Curses.KeyLeft        -> SpecialKey "Left"
    Curses.KeySLeft       -> SpecialKey "Shift-Left"
    Curses.KeyUnknown 552 -> SpecialKey "Ctrl-Left"
    Curses.KeyUnknown 553 -> SpecialKey "Ctrl-Shift-Left"
    Curses.KeyRight       -> SpecialKey "Right"
    Curses.KeySRight      -> SpecialKey "Shift-Right"
    Curses.KeyUnknown 567 -> SpecialKey "Ctrl-Right"
    Curses.KeyUnknown 568 -> SpecialKey "Ctrl-Shift-Right"
